...
!================== File 2  ================================
  ...
  logical :: exist
  character(len=100) :: fileName1='/home/om1014/PhD/INCOMPACT3D/TBL/CanonicalLong/sauve.dat'
  !character(len=100) :: fileName1='/home/om1014/PhD/INCOMPACT3D/Channel/channel/sauve_orig.dat'
  character(len=100) :: fileName2='./sauve.dat'
  !character(len=100) :: fileName2='/home/om1014/PhD/INCOMPACT3D/Channel/channel/sauve_in.dat'
!!! ============== File 1 ===================================
  allocate(y1(ny1))
  xlx1=1500.! 12.5663706144 !500.
  yly1=40. !2. !40.
  zlz1=15. !2. !40.
  istret1=3 !2 !3
  beta1=0.8 !0.259065151 !1.3
  ncly1=2
  dx1=xlx1/(nx1-1)
  dz1=zlz1/(nz1-1)
  DO I=1,nx1
...
print *, 'Mapping the variable number : ',i_var
!call cpu_time(t1)
call system_clock ( t1, clock_rate, clock_max )

call  OMP_SET_NUM_THREADS(4)

!$OMP PARALLEL private  (ay0,ay1,ay2,ax0,ax1,ax2,az0,az1,az2,j1_start,k1_start,i1_start,ID_thrd,NTHRDS,dny2,dnx2,dny1,dnx1)

nthrds=OMP_GET_NUM_THREADS()
!PRINT *, 'NTHRDS ', NTHRDS


ID_thrd=OMP_GET_THREAD_NUM()
!PRINT *, 'ID_thrd ', ID_thrd
!k1_start=2
k1_start=(nz1/nthrds)*ID_thrd+2
...
j1_start=2
do j2=1,ny2-dny2
!if (k2 == 127) print *, 'j2 ',J2
i1_start=2
do i2=1,nx2-dnx2
   !if (i_var==2 .and. ID_thrd==0) then
    !    print *, 'i1_start  j1_start  k1_start' ,i1_start ,j1_start,k1_start
   !endif
   !if (k2 == 127 .and. j2==513) print *, 'i2 ',I2
   do k1=k1_start,nz1-(nz1/nthrds)*(nthrds-ID_thrd-1)
  ! if (k2 == 127 .and. j2==513 .and. I2==6145) print *, 'k1 ',k1
   do j1=j1_start,ny1-dny1
   !if (k2 == 127 .and. j2==513 .and. I2==6145 .and. k1==127) print *, 'j1 ',j1  
   do i1=i1_start,nx1-dnx1
     !  if (i_var==2 .and. ID_thrd==0) then
      !      print *, 'ID',ID_thrd, 'i1  j1  k1 ', i1 , j1 , k1, 'i2  j2  k2  ',i2 , j2 , k2
      ! endif
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ...
   ! if (k2 == 127 .and. j2==513 .and. I2==6145 .and. k1==127 .and. j1==321) print *, 'i1 ',i1
    enddo
    enddo
    enddo
10 enddo 
...
print *, 'Time of mapping the variable (s) = ',real ( t2 - t1 ) / real ( clock_rate )
!ux2(nx2,:,:)=ux1(nx1,:,:)
!ux2(:,ny2,:)=ux1(:,ny1,:)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
